...
function deleteCommentButton(id_commento, commento) {
  ...
  <tr>
    <td>
      ...
      <span id="new-form-comment"><a href="/api/document/modify/comment/${id_commento}" id="modify-comment"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
